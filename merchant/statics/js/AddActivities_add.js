...
var addactivities = {
	...
	tijiao: function() {
		...
		var B = {};
		B.title = addactivities.converthtml($.trim($("#activityTitle").val())) || "默认标题";
		B.description = "";
		...
		B.end_datetime = startDate4 + "T" + $("#endHour").val() + ":00";
		B.SpreadLink = "";
	...
	zancun: function() {
		...
		var C = {};
		C.title = addactivities.converthtml($.trim($("#activityTitle").val())) || "默认标题";
		C.description = "";
